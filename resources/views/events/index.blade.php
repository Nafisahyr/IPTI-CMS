    ...
    <div class="max-w-screen-xl mx-auto p-6">
                    ...
                    @foreach ($events as $event)
                        <tr
                            ...
                            <img src="{{ asset('storage/' . $event->thumbnail) }}"
                                class="w-20 h-20 object-cover rounded-lg shadow-sm" alt="{{ $event->title }}">
                            </td>
                            <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                {{ $event->title }}
                            </td>
                            <td class="px-6 py-4 max-w-xs">
                                <p class="text-gray-700 dark:text-gray-300 line-clamp-2">{{ $event->description }}</p>
                            </td>
                            <td class="px-6 py-4">
                                @if ($event->link)
        ...
        @else
            <div class="text-center py-12">
                ...
                <h3 class="mt-4 text-lg font-medium text-gray-900 dark:text-white">No events yet</h3>
                <p class="mt-2 text-gray-500 dark:text-gray-400">Get started by creating your first event.</p>
