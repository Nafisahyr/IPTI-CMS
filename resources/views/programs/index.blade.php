    ...
    <div class="max-w-screen-xl mx-auto p-6">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href=""
                            class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400 dark:hover:text-white">Program Detail</a>
                    </div>
                </li>
            </ol>
        </nav>
                    ...
                    @foreach ($programs as $program)
                        <tr
                            ...
                            <td class="px-6 py-4 max-w-xs">
                                <p class="text-gray-700 dark:text-gray-300 line-clamp-2">{{ $program->description }}</p>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex flex-wrap gap-2 justify-start">
                                    <!-- Detail Button -->
                                    <a href="{{ route('programdetail.create', $program->id) }}"
                                        class="flex items-center gap-2 px-3 py-2 text-sm font-medium text-blue-600 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors dark:bg-blue-900/20 dark:text-blue-400 dark:hover:bg-blue-900/30">
                                    ...
                                    <form action="{{ route('programs.destroy', $program->id) }}" method="POST"
                                        ...
                                        <button type="submit"
                                            ...
                                            class="flex items-center gap-2 px-3 py-2 text-sm font-medium text-red-600 bg-red-50 rounded-lg hover:bg-red-100 transition-colors dark:bg-red-900/20 dark:text-red-400 dark:hover:bg-red-900/30">
                                            <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        @else
            <div class="text-center py-12">
                ...
                <h3 class="mt-4 text-lg font-medium text-gray-900 dark:text-white">No programs yet</h3>
                <p class="mt-2 text-gray-500 dark:text-gray-400">Get started by creating your first program.</p>
                <div class="mt-6">
                    <button data-modal-target="addProgramModal" data-modal-toggle="addProgramModal"
                        class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
                        <svg class="w-5 h-5 me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
