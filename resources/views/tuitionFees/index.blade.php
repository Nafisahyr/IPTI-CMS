...
@section('content')
    <div class="max-w-screen-xl mx-auto p-6">
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Tuition Fee</h1>
            </div>

            <!-- Add tuitionFee Button -->
                            ...
                            <td class="px-6 py-4">
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    <form action="{{ route('tuitionFees.destroy', $tuitionFee->id) }}" method="POST"
                                        ...
                                        @method('DELETE')
                                        <button type="submit"
                                            onclick="return confirm('Are you sure you want to delete this tuitionFee?')"
