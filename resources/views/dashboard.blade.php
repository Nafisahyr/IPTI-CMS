        ...
        <div class="bg-white rounded-xl shadow-md border border-gray-200 p-6 hover:shadow-lg transition-shadow duration-300">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-2">Upcoming & past events</p>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">{{ $program->degree ?: 'No degree specified' }}</p>
                            </div>
                        </div>
        ...
        <div class="bg-white rounded-xl shadow-md border border-gray-200">
            <div class="border-b border-gray-200 p-6">
                ...
                <p class="text-sm text-gray-600 mt-1">Events happening soon</p>
            </div>
            <div class="p-6">
