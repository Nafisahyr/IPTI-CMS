...
<x-modal id="editBannerModal{{ $banner->id }}" title="Edit Banner" :showButton="false">
    <form method="POST" action="{{ route('banners.update', $banner->id) }}" enctype="multipart/form-data">
        ...
        <div class="grid gap-4 mb-4">
            ...
            <div>
                <label for="edit_image_{{ $banner->id }}" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Banner Image</label>
                <input type="file" name="image" id="edit_image_{{ $banner->id }}"
        ...
        <div class="flex justify-end space-x-3">
            <button type="button"
                    data-modal-hide="editBannerModal{{ $banner->id }}"
