        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden">
            ...
            <div class="p-10 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="bg-gray-50 p-6 rounded-lg border border-gray-200 min-h-[150px]">
                            <p class="text-gray-800 leading-relaxed">
                                Queen said--' 'Get to your tea; it's getting late.' So Alice began to cry again, for she
                                had plenty of time as she could not taste theirs, and the Queen never left off when they
                                liked, and left.
                            </p>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <div class="bg-gray-50 p-3 rounded-lg border border-gray-200">
                            <p class="text-gray-800 font-medium">Jun 8, 2025</p>
                        </div>
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <div class="bg-gray-50 p-6 rounded-lg border border-gray-200 min-h-[150px]">
                        <p class="text-gray-800 leading-relaxed">
                            Queen said--' 'Get to your tea; it's getting late.' So Alice began to cry again, for she had
                            plenty of time as she could not taste theirs, and the Queen never left off when they liked,
                            and left.
                        </p>
                    </div>
                </div>
            ...
            <div class="border-t border-gray-200 p-6 bg-gray-50">
                <div class="flex justify-end">
                    <div class="flex space-x-3">
                        {{-- <form action="{{ route('program_details.destroy', $programDetails->id) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE') --}}
