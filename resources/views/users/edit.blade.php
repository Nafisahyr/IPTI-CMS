        ...
        <div class="flex-1">
            <form action="{{ route('profile.avatar.update') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    @if ($user->avatar)
                        <!-- Jika sudah ada avatar, hanya tampilkan "Change Photo" -->
                        <div>
                            <input type="file" name="avatar" id="avatar" accept="image/*" class="hidden"
                                onchange="this.form.submit()">
                            <label for="avatar"
                                class="cursor-pointer inline-flex items-center justify-center px-6 py-3 text-sm font-medium text-white bg-teal-500 hover:bg-teal-600 rounded-lg focus:ring-4 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 shadow-md transition-all duration-200 w-full sm:w-auto">
                    ...
                    @else
                        <!-- Jika belum ada avatar, tampilkan "Upload New Photo" -->
                        <div class="flex-1">
                            <input type="file" name="avatar" id="avatar" accept="image/*" class="hidden"
                                onchange="this.form.submit()">
                            <label for="avatar"
            ...
            <!-- Form Remove Avatar (hidden) -->
            @if ($user->avatar)
            <form id="removeAvatarForm" action="{{ route('profile.avatar.remove') }}" method="POST" class="hidden">
                @csrf
                @method('DELETE')
            </form>
            @endif
            ...
            <form action="{{ route('users.update') }}" method="POST" class="p-8">
                ...
                <div
                    ...
                    <div class="flex space-x-3">
                        ...
                        <button type="submit"
                            class="px-6 py-3 text-sm font-medium text-white bg-teal-500 rounded-lg shadow-md hover:bg-teal-600 transition-all duration-200">
                            Save Changes
                        </button>
                    </div>
                </div>
