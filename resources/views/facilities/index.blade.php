...
@section('content')
    <div class="max-w-screen-xl mx-auto p-6">
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Facility</h1>
            </div>
                    ...
                    @foreach ($facilities as $facility)
                        <tr
                            ...
                            <td class="px-6 py-4 max-w-xs">
                                <p class="text-gray-700 dark:text-gray-300 line-clamp-2">{{ $facility->description }}</p>
                            </td>
                            <td class="px-6 py-4">
        ...
        @else
            <div class="text-center py-12">
                ...
                <h3 class="mt-4 text-lg font-medium text-gray-900 dark:text-white">No facilities yet</h3>
                <p class="mt-2 text-gray-500 dark:text-gray-400">Get started by creating your first facility.</p>
                <div class="mt-6">
                    <button data-modal-target="addFacilityModal" data-modal-toggle="addFacilityModal"
