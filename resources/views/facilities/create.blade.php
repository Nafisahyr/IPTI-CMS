<x-modal id="addFacilityModal" title="Add New Facility" :showButton="false">
    <form method="POST" action="{{ route('facilities.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="grid gap-4 mb-4">
            <div>
                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Facility Name *</label>
            ...
            <div>
                <label for="image" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Facility Image *</label>
        ...
        <div class="flex justify-end space-x-3">
            <button type="button"
                    data-modal-hide="addFacilityModal"
